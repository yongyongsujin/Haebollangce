			...
			success:function(json){
				...
				if(code == 0) {
					...
					if(json.length > 0){
						...
						html = "<tr><td class='td_width_33'>완료된 챌린지가 없습니다.</td></tr>"
					...
					if(json.length > 0){
						...
						let ratio = (fin_cnt/$("input#all_cnt").val())*100;
	...
	<div id="mainPosition">
		<!-- index 상단 제목 시작 -->
 		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">완료된 챌린지 현황</h1>
		</div>
		<!-- index 상단 제목 끝 -->
		...
		<div class="row mb-4">
			...
			<div class="row">
				...
				<div class="col-xl-4 col-lg-4">
					<div class="card shadow mb-4">
						...
						<div class="card-header py-3">
							<h5 class="m-0 font-weight-bold">참여한 챌린지 비율</h5>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
			...
			<div class="row">
				<div class="col-lg-12 mb-8">
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h5 class="m-0 font-weight-bold">완료한 챌린지 리포트</h5>
						</div>
						<div class="card-body">
							<div class="chart-bar">
