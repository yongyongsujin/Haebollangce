	    ...
	    <div class="card p-3 mb-5 mt-5" >
	        <div class="d-flex justify-content-between">
	            <div class="d-flex flex-row align-items-center">
	                ...
	                <div class="c-details">
	                    <h6 class="mb-0 ml-4">평일민주</h6> <span class="ml-4">1 days ago</span>
	                </div>
	            </div>
	        ...
	        <div class="mt-4">
	            ...
	            <div class="mt-5">
	                ...
	                <div class="mt-4"> 
	                	<span class="text1 ">
	                		<img src="https://images.munto.kr/munto-web/ic_action_like-empty-black_30px.svg?s=32x32"/>56
	                		<img src="https://images.munto.kr/munto-web/ic_action_comment_30px.svg?s=32x32"/>13
	                	</span> 
	                	<span class="text1 ">
	                		<i class="fa-regular fa-pen-to-square btn btn-edit" style="color: gray;">&nbsp;글 수정하기</i>
	                		<i class="fa-regular fa-trash-can btn btn-del" style="color:gray;">&nbsp;글 삭제하기</i>
	                	</span> 
	                </div>
	            </div>
	        </div>
